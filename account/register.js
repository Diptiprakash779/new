...
class Register extends Component{
    ...
    register = (obj) =>{
        ...
        if( !fieldList["mypassword"] || fieldList["mypassword"].length<6){
            formStatus = false;
            errorList["passError"] = "Please Enter Your Password between 6 to 8 length";
        }else{
            errorList["passError"] = "";
        }
        ...
        if( !mpattern.test(fieldList["mymobile"])){
            formStatus = false;
            errorList["mobileError"] = "Please Enter Your Valid Mobile Number";
        }else{
            errorList["mobileError"] = "";
        }

        //adding message which can behave according to the situation
        let mymessage = '';
        if(formStatus == false){
        ...
        //updating the errorList after checking inputfields
        this.setState({
            errorList,
            message:mymessage
        })
                        ...
                        <form onSubmit={this.register}>
                            <div className="card">
                                <div className="card-header bg-primary text-white">
                                    ...
                                    <label className="fa fa-pull-right">
                                        <Link to="/" className="text-warning">
                                            <i className="fa fa-lock"></i>Already registered ?
                                        </Link>
                                    </label>
                                </div>
                                <div className="card-body">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="number" className="form-control" name="mymobile" onChange={this,this.processInput}/>
